...
import survey020 from '../../../lib/blockchain/abis/polygon/survey020';
dotenv.config();
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const goerliProvider = `${process.env.MUMBAI_NETWORK_PROVIDER}`.split(',')

    const provider = new JsonRpcProvider(goerliProvider[0])
