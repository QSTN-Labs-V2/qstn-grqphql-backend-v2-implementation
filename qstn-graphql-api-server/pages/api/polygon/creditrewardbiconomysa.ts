...
import vault010 from '../../../lib/blockchain/abis/polygon/vault010';
dotenv.config();
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    const signer = new Wallet(process.env.POLYGON_MAIN_ACCOUNT_PRIVATE_KEY, provider);

  try {

    console.log('START CREDITING REWARD ===> ');
    console.log('AMOUNT ===> ', parseEther(amount));
    console.log('VAULT/WALLET ADDRESS ===> ', userAddress);
